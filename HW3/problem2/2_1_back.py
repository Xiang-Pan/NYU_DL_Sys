...
class ResNetLightningModule(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        return torch.utils.data.DataLoader(train_dataset, batch_size=self.batch_size, shuffle=True, num_workers=2)
    ...
    def test_dataloader(self):
        ...
        return torch.utils.data.DataLoader(test_dataset, batch_size=self.batch_size, shuffle=False, num_workers=2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', type=str, default='128')
    ...
    trainer = pl.Trainer(gpus=args.gpus, max_epochs=2, logger=logger, strategy='dp', profiler="simple")
