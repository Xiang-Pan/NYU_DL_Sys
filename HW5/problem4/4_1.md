 ...
 * @LastEditTime: 2022-05-06 22:02:48
...
Continuous: Current action will affect the next action. When we play the poker game, current action will affect the next action, that's continuous. Or we can use the DOTA2 Game Bots as exmaple, each actor current action will affect the next action space within one game.
</font>
